...
{
public:
    Mobile_Arm(int mn, string n, int bl, int l, int wl, int el, int ml) : Super_Arm(mn, n, bl, l, wl, el, ml), Mobile_Robot(mn, n, bl), Robot(mn, n, bl) {Mobile_Robot::set_type("Mobile_Arm");};
